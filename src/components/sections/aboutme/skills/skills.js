...
import {SkillsContainer, DevelopmentSkills, DesignSkills} from './skills.-styling';
...
const devSkills = [{Icon: Javascript ,name: 'Javascript' }, {Icon: ReactLogo ,name: 'React JS' }, {Icon: Html5 ,name: 'HTML5' }, {Icon: Css3 ,name: 'Css' },{Icon: NodeDotJs ,name: 'Node JS' },{Icon: Git ,name: 'Git' },{Icon: Sass ,name: 'Sass' }];
const designSkills = [ {Icon: Adobexd ,name: 'Adobe XD' }, {Icon: Adobephotoshop ,name: 'Photoshop' }, {Icon: Adobeillustrator ,name: 'Illustrator' },{Icon: Adobepremierepro ,name: 'Premiere' }, {Icon: Adobelightroom ,name: 'Lightroom' }]
...
function Skills(){
    ...
    return(
        <SkillsContainer>
            <DevelopmentSkills>
                {styleSkills(devSkills, Skill)}
            </DevelopmentSkills>
            <DesignSkills>
                {styleSkills(designSkills, Skill)}
            </DesignSkills>
        </SkillsContainer>
    )
}
